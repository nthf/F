...
class Util_Db_Mysqli extends Util_Db_Abstract
{
    /**
     * Connect to database
     *
    ...
    protected function _connect($params)
    {
        if (!extension_loaded('mysqli')) {
            throw new Util_Db_Exception('NO_MYSQLI_EXTENSION_FOUND');
        }

        if ($params['persistent']) {
            throw new Util_Db_Exception('MYSQLI_EXTENSTION_DOES_NOT_SUPPORT_PERSISTENT_CONNECTION');
        }
        ...
        if (false === $connected) {
            throw new Util_Db_Exception($this->error());
        }
    ...
    public function query($sql)
    {
        ...
        throw new Util_Db_Exception($msg);
    }
