...
class Util_Db_Masterslave extends Util_Db_Abstract
{
    /**
     * Configuration
     *
    ...
    public function master()
    {
        ...
        $this->_master = Util_Db::factory($config);
    ...
    public function slave($name = null)
    {
        ...
        $this->_slave = Util_Db::factory($config);
    ...
    public function __get($key)
    {
        switch ($key) {
            ...
            default:
                throw new Util_Db_Exception('Undefined property: ' . get_class($this). '::' . $key);
        }
    }
}
